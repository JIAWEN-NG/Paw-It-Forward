//marketplaceModel.js
class Donation {
    constructor(id, donorId, donorName, donorProfileImage, receiverId, requestId, itemsDonated, condition, itemCategory, petType, itemImage, createdAt, itemDescription) {
        this.id = id;
